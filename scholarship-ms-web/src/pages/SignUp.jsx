...
import { BsPersonFillLock,BsKeyFill,BsEnvelopeArrowUpFill, BsGeoAltFill, BsBank } from 'react-icons/bs'
        ...
        <div className='w-10/12 h-full lg:flex m-auto'>
          ...
          <div className='lg:w-1/3 flex justify-center items-center'>
            <form className='flex-col w-full'>
              ...
              <InputField name={"Enter your schoolName"} placeholder={"schoolName"} value={schoolName} onChange type="text" icon={<BsEnvelopeArrowUpFill />} />
              ...
              <InputField name={"Enter School Address"} placeholder={"Address"} value={password} onChange type="text" icon={<BsGeoAltFill />} />
