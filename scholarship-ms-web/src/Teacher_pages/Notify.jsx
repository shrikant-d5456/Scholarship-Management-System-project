...
const Notify = () => {
    return (
        <div className='bg-white w-full'>
            ...
            <p className='text-2xl font-bold py-4 ml-2 text-[#269CFF] flex gap-4 justify-start items-center'><BsBell /> Notifications</p>

            <div className='flex justify-start items-center gap-4 px-4 py-1 border-b-2 mb-2 border-yellow-600 bg-yellow-100 rounded-xl'>
                <div className='w-1/8'>
